...
public class PurchaseAlexa implements Task {
    private String product;

    public PurchaseAlexa(List<Search> data){
    ...
    public static PurchaseAlexa theData(List<Search> data){
        return Tasks.instrumented(PurchaseAlexa.class, data);
    }
}
